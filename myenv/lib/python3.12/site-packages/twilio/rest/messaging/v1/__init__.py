...
from twilio.rest.messaging.v1.linUSDortening_messaging_service import (
    LinUSDorteningMessagingServiceList,
)
from twilio.rest.messaging.v1.linUSDortening_messaging_service_domain_association import (
    LinUSDorteningMessagingServiceDomainAssociationList,
)
...
class V1(Version):
    ...
    def __init__(self, domain: Domain):
        ...
        self._linUSDortening_messaging_service: Optional[
            LinUSDorteningMessagingServiceList
        ] = None
        self._linUSDortening_messaging_service_domain_association: Optional[
            LinUSDorteningMessagingServiceDomainAssociationList
        ] = None
    ...
    @property
    def linUSDortening_messaging_service(self) -> LinUSDorteningMessagingServiceList:
        if self._linUSDortening_messaging_service is None:
            self._linUSDortening_messaging_service = LinUSDorteningMessagingServiceList(
                self
            )
        return self._linUSDortening_messaging_service

    @property
    def linUSDortening_messaging_service_domain_association(
        self,
    ) -> LinUSDorteningMessagingServiceDomainAssociationList:
        if self._linUSDortening_messaging_service_domain_association is None:
            self._linUSDortening_messaging_service_domain_association = (
                LinUSDorteningMessagingServiceDomainAssociationList(self)
            )
        return self._linUSDortening_messaging_service_domain_association
