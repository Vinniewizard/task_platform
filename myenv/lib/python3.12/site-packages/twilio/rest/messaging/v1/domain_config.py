...
class DomainConfigInstance(InstanceResource):
    ...
    :ivar continue_on_failure: Boolean field to set customer delivery preference when there is a failure in linUSDortening service
    ...
    def update(
        ...
        :param continue_on_failure: Boolean field to set customer delivery preference when there is a failure in linUSDortening service
...
class DomainConfigContext(InstanceContext):
    ...
    def __init__(self, version: Version, domain_sid: str):
        ...
        self._uri = "/LinUSDortening/Domains/{domain_sid}/Config".format(
            **self._solution
        )
