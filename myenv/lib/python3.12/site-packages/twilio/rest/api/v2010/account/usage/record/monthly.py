...
class MonthlyInstance(InstanceResource):
    ...
    :ivar price_unit: The currency in which `price` is measured, in [ISO 4127](https://www.iso.org/iso/home/standards/currency_codes.htm) format, such as ``, `eur`, and `jpy`.
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], account_sid: str):
        ...
        self.category: Optional["MonthlyInstance.Category"] = payload.get("category")
...
class MonthlyList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str):
        ...
        self._uri = "/Accounts/{account_sid}/Usage/Records/Monthly.json".format(
            **self._solution
        )

    def stream(
        self,
        category: Union["MonthlyInstance.Category", object] = values.unset,
        ...
        :param &quot;MonthlyInstance.Category&quot; category: The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
    ...
    async def stream_async(
        ...
        limit: Optional[int] = None,
        page_size: Optional[int] = None,
    ) -> AsyncIterator[MonthlyInstance]:
        """
        Asynchronously streams MonthlyInstance records from the API as a generator stream.
        This operation lazily loads records as efficiently as possible until the limit
        is reached.
        The results are returned as a generator, so this operation is memory efficient.
    ...
    async def list_async(
        ...
        """
        Asynchronously lists MonthlyInstance records from the API as a list.
        Unlike stream(), this operation is eager and will load `limit` records into
        memory before returning.
    ...
    async def page_async(
        ...
        """
        Asynchronously retrieve a single page of MonthlyInstance records from the API.
        Request is executed immediately
    ...
    async def get_page_async(self, target_url: str) -> MonthlyPage:
        """
        Asynchronously retrieve a specific page of MonthlyInstance records from the API.
        Request is executed immediately
