...
class CallInstance(InstanceResource):
    ...
    :ivar price_unit: The currency in which `Price` is measured, in [ISO 4127](https://www.iso.org/iso/home/standards/currency_codes.htm) format (e.g., ``, `EUR`, `JPY`). Always capitalized for calls.
