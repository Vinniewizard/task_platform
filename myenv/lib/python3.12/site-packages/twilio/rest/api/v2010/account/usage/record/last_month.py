...
class LastMonthInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], account_sid: str):
        ...
        self.category: Optional["LastMonthInstance.Category"] = payload.get("category")
...
class LastMonthList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str):
        ...
        self._uri = "/Accounts/{account_sid}/Usage/Records/LastMonth.json".format(
            **self._solution
        )

    def stream(
        self,
        category: Union["LastMonthInstance.Category", object] = values.unset,
    ...
    async def stream_async(
        ...
        limit: Optional[int] = None,
        page_size: Optional[int] = None,
    ) -> AsyncIterator[LastMonthInstance]:
        """
    ...
    def get_page(self, target_url: str) -> LastMonthPage:
        """
    ...
    async def get_page_async(self, target_url: str) -> LastMonthPage:
        """
