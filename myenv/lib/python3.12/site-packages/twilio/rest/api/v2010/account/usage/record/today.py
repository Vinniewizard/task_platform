...
class TodayInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], account_sid: str):
        ...
        self.category: Optional["TodayInstance.Category"] = payload.get("category")
...
class TodayPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> TodayInstance:
        """
...
class TodayList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str):
        ...
        self._uri = "/Accounts/{account_sid}/Usage/Records/Today.json".format(
            **self._solution
        )

    def stream(
        self,
        category: Union["TodayInstance.Category", object] = values.unset,
        ...
        :param &quot;TodayInstance.Category&quot; category: The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
    ...
    async def list_async(
        ...
        """
        Asynchronously lists TodayInstance records from the API as a list.
        Unlike stream(), this operation is eager and will load `limit` records into
        memory before returning.
    ...
    async def page_async(
        ...
        """
        Asynchronously retrieve a single page of TodayInstance records from the API.
        Request is executed immediately
    ...
    async def get_page_async(self, target_url: str) -> TodayPage:
        """
        Asynchronously retrieve a specific page of TodayInstance records from the API.
        Request is executed immediately
