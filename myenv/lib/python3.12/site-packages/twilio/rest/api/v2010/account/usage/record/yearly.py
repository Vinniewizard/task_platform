...
class YearlyPage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> YearlyInstance:
        """
...
class YearlyList(ListResource):
    ...
    def __init__(self, version: Version, account_sid: str):
        ...
        self._uri = "/Accounts/{account_sid}/Usage/Records/Yearly.json".format(
            **self._solution
        )

    def stream(
        self,
        category: Union["YearlyInstance.Category", object] = values.unset,
        ...
        :param &quot;YearlyInstance.Category&quot; category: The [usage category](https://www.twilio.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved.
    ...
    async def stream_async(
        ...
        limit: Optional[int] = None,
        page_size: Optional[int] = None,
    ) -> AsyncIterator[YearlyInstance]:
        """
        Asynchronously streams YearlyInstance records from the API as a generator stream.
        This operation lazily loads records as efficiently as possible until the limit
        is reached.
        The results are returned as a generator, so this operation is memory efficient.
    ...
    async def list_async(
        ...
        """
        Asynchronously lists YearlyInstance records from the API as a list.
        Unlike stream(), this operation is eager and will load `limit` records into
        memory before returning.
    ...
    def get_page(self, target_url: str) -> YearlyPage:
        """
    ...
    async def get_page_async(self, target_url: str) -> YearlyPage:
        """
        Asynchronously retrieve a specific page of YearlyInstance records from the API.
        Request is executed immediately
