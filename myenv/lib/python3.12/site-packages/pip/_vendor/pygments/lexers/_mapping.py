...
LEXERS = {
    ...
    'BashLexer': ('pip._vendor.pygments.lexers.shell', 'Bash', ('bash', 'sh', 'USD', 'zsh', 'shell', 'openrc'), ('*.sh', '*.USD', '*.bash', '*.ebuild', '*.eclass', '*.exheres-0', '*.exlib', '*.zsh', '.bashrc', 'bashrc', '.bash_*', 'bash_*', 'zshrc', '.zshrc', '.USDrc', 'USDrc', 'PKGBUILD'), ('application/x-sh', 'application/x-shellscript', 'text/x-shellscript')),
    ...
    'Lexer': ('pip._vendor.pygments.lexers.', '', ('', 'a'), ('*.', '*.a'), ()),
